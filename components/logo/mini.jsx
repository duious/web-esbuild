const LogoIcon = ({ className, style, width = 200, height = 64, fill = '#21a2ff', color = '' }) => {
    return (
        <svg className={className} style={style} viewBox="-13 0 58 34.09" width={`${width}px`} height={`${height}px`}>
            <defs>
                <linearGradient
                    id="未命名的渐变_20"
                    x1="43.76"
