 ...
 * sNumber.pad0(123, 2, '-'); // '123'
 */
declare const pad0: (string: string | number, length?: number, chars?: string) => string;
/**
 * 数字 正则表达式
 * @static
 * @since 0.0.3
...
declare const _default: {
    NUMBER: RegExp;
    pad0: (string: string | number, length?: number, chars?: string) => string;
    isNumber: (number: string) => boolean;
};
export default _default;
export { NUMBER, pad0, isNumber };
