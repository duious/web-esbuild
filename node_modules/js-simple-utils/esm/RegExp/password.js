 ...
 */
const PASSWORD_ALL_6_16 = /^[\x21-\x7E]{6,16}$/;
/**
 * 判断是否是密码
 * @static
 * @since 0.0.2
 ...
 */
const isPassword = (password) => PASSWORD.test(password);
/**
 * 判断是否是密码
 * @static
 * @since 0.0.2
 ...
 */
const isPasswordNum4 = (password) => PASSWORD_NUM_4.test(password);
/**
 * 判断是否是密码
 * @static
 * @since 0.0.2
 ...
 */
const isPasswordNum6 = (password) => PASSWORD_NUM_6.test(password);
/**
 * 判断是否是密码
 * @static
 * @since 0.0.2
 ...
 */
const isPasswordAll6To16 = (password) => PASSWORD_ALL_6_16.test(password);
var password = {
    PASSWORD,
    PASSWORD_NUM_4,
    PASSWORD_NUM_6,
...
export { PASSWORD, PASSWORD_ALL_6_16, PASSWORD_NUM_4, PASSWORD_NUM_6, password as default, isPassword, isPasswordAll6To16, isPasswordNum4, isPasswordNum6 };
